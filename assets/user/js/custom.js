...
$(function ($) {
    ...
    ******************************************************/
    $(document).off('click.turboEditbtn', '.editbtn').on('click.turboEditbtn', '.editbtn', function () {
        let datas = $(this).data();
        delete datas['toggle'];
    ...
    ******************************************************/
    $(document).off('click.turboUpdateBtn', '#updateBtn').on('click.turboUpdateBtn', '#updateBtn', function (e) {
